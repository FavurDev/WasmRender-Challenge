...
// CHANGELOG: Sprint 11 (2026-09-23): RC-4 surface additions, TD-024 named constants + readPixels F8 guard reorder, exactness-p2 framebuffer guards.
// CHANGELOG: Sprint 13 (2026-09-24): T3 state wave: spec-minimum limit queries SUBPIXEL_BITS 0x0D50=4, MAX_ELEMENT_INDEX 0x8FFE=0xffffff, and UNPACK_COLORSPACE_CONVERSION_WEBGL getParameter passthrough to glState (remediation 349a3eb).
